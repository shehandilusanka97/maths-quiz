...
public class Level4FormController {
    public Label score;
    public Label level;
    ...
    public void onAction_btnNum1(ActionEvent actionEvent) throws IOException {
    ...
    public void onAction_btnNum2(ActionEvent actionEvent) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("../view/Level5Form.fxml"));
