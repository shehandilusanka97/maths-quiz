...
public class Level5FormController {
    public Label score;
    public Label level;
    ...
    public void onAcrtion_btnNum3(ActionEvent actionEvent) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("../view/Level6Form.fxml"));
